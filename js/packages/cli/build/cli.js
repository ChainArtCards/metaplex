    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 7:
                ...
                return [4 /*yield*/, helper_1.sendTransactionWithRetryWithKeypair(solConnection, walletKey, instructions, [], 'single')];
            case 8:
                tx = _e.sent();
            ...
            case 9:
                ...
                return [4 /*yield*/, node_fetch_1.default('https://us-central1-principal-lane-200702.cloudfunctions.net/uploadFile3', {
                        method: 'POST',
                        body: data,
                    })];
            ...
            case 15:
                ...
                return [4 /*yield*/, Promise.all(chunks(Array.from(Array(keys.length).keys()), 1000).map(function (allIndexesInSlice) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    onChain = indexes.filter(function (i) {
                                        var _a;
                                        var index = keys[i];
                                        return (_a = cacheContent.items[index]) === null || _a === void 0 ? void 0 : _a.onChain;
                                    });
                                    ind = keys[indexes[0]];
                                    if (!(onChain.length != indexes.length)) return [3 /*break*/, 3];
                                    console.log('Writing indices ', ind, '-', keys[indexes[indexes.length - 1]]);
...
commander_1.program
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 2]), candyMachine = _a[0], _ = _a[1];
...
commander_1.program
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 2]), candyMachine = _a[0], bump = _a[1];
...
commander_1.program
    ...
    .option('-c, --cache-name <path>', 'Cache file name')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var solConnection, keypair, solPriceStr, lamports, cacheName, cachePath, cachedContent, mint, walletKey, token, walletWrapper, provider, idl, anchorProgram, config, _a, candyMachine, bump, candy, metadata, masterEdition, tx, _b, _c, _d, _e;
    var _f, _g;
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, getCandyMachine(config, cachedContent.program.uuid)];
            case 3:
                _a = __read.apply(void 0, [_h.sent(), 2]), candyMachine = _a[0], bump = _a[1];
...
commander_1.program
    ...
    var solConnection, cacheName, cachePath, cachedContent, config, number, keys, i, key, thisSlice, name_1, uri, cacheItem;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                solConnection = new anchor.web3.Connection("https://api." + ENV + ".solana.com/");
            ...
            case 1:
                config = _a.sent();
                number = new bn_js_1.default(config.data.slice(247, 247 + 4), undefined, 'le');
                ...
                for (i = 0; i < keys.length; i++) {
                    ...
                    name_1 = helper_1.fromUTF8Array(__spreadArray([], __read(thisSlice.slice(4, 36))));
                    uri = helper_1.fromUTF8Array(__spreadArray([], __read(thisSlice.slice(40, 240))));
